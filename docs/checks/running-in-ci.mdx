...
![GitHub PR showing Continue checks with pass and fail status](/images/checks-pr-status.png)
...
![Continue check review page showing suggested diff with accept and reject options](/images/checks-accept-reject.png)
