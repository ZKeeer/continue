  ...
  <Tab title="Manual Setup">
    <Steps>
      <Step title="Create an Agent on Continue Hub">
        Go to the [Continue Hub](https://continue.dev) and [create a new agent](https://continue.dev/agents/new).
      </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Continue Hub" icon="globe" href="https://continue.dev">
