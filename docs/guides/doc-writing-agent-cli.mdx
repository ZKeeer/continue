...
<CardGroup cols={1}>
  ...
  <Card title="Continue API Key" icon="key">
    Get your API key from [Continue Mission Control](https://continue.dev/settings/api-keys) and set:
    ```bash
...
<CardGroup cols={2}>
  ...
  <Card title="Continue Mission Control" icon="users" href="https://continue.dev">
