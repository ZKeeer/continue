...
<Steps>
  ...
  <Step title="Publish to Continue Mission Control">
    Share your docs MCP on [Continue Mission Control](https://continue.dev/new?type=mcp) so others can use it with Continue agents.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Join Discussions" icon="comments" href="https://github.com/continuedev/continue/discussions">
