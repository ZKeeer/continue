...
<Note>
  ...
  **Mission Control Benefits:**
  ...
  - **Dedicated inbox view** - Monitor all Sentry-related agent activity at [continue.dev/inbox?view=sentry](https://continue.dev/inbox?view=sentry)
    ...
    **Perfect for:** Immediate error analysis with AI-powered root cause detection and built-in debugging
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Sentry Continuous AI Agent](https://continue.dev/continuedev/sentry-continuous-ai-agent) on Continue Mission Control and click **"Install Agent"** or run:
