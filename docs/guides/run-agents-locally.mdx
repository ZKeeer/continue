...
- [Continue CLI installed](/cli/quickstart)
...
<CardGroup cols={2}>
  <Card title="Beyond Checks" icon="robot" href="/mission-control/beyond-checks">
    Learn about agents, triggers, and automation
  </Card>

  <Card title="CLI Reference" icon="terminal" href="/cli/quickstart">
