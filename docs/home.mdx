...
3. Discover the models, prompts, rules, MCP tools, and agents you need to automate your workflows with AI on [Continue Mission Control](https://continue.dev/)
