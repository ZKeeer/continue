...
<Tabs>
    <Tab title="Hub">
    Add the [xAI Grok-4.1 block](https://continue.dev/xai/grok-4-1-fast-non-reasoning) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
<Tabs>
    <Tab title="Hub">
    Add the [Gemini 3.1 Pro block](https://continue.dev/google/gemini-3.1-pro-preview) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
