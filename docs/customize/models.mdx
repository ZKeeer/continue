...
2. Add [Claude Sonnet 4.6](https://continue.dev/anthropic/claude-sonnet-4-6) to a config on Continue Mission Control
...
2. Add [Gemini 3.1 Pro](https://continue.dev/google/gemini-3.1-pro-preview)  a config on Continue Mission Control
