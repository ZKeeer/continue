...
<Tip>
  If you haven't already, create an account and connect your GitHub repositories in [Mission Control](https://continue.dev/).
</Tip>
...
<Info>
  **New to agents?** Check out our [pre-configured agents](/mission-control/beyond-checks) to test out a workflow immediately.
</Info>
...
<Steps>
  ...
  <Step title="🎯 Access Mission Control">
    Go to [Mission Control](https://continue.dev/) and:
